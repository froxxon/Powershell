...
<Window x:Name="Form" x:Class="InstallServerGUI.MainWindow"
    ...
    <Grid x:Name="grd1" Margin="0" Opacity="0.9">
        ...
        <Button x:Name="btnReloadOUs" Content="↻" HorizontalAlignment="Left" VerticalAlignment="Top" Width="31" Margin="370,263,0,0" Height="22" FontWeight="Bold" TabIndex="11" ToolTip="Uppdatera OUs"/>
